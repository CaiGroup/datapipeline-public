...
def hist_jump_threshed_3d(tiff_3d, strictness, tiff_src, analysis_name, nbins):
    nbins = float(nbins)
...
if sys.argv[1] == 'debug_jump_helper':
    ...
    num_bins=70
    dot_analysis = list(hist_jump_threshed_3d(tiff_3d, strictness, tiff_src, analysis_name, num_bins))
