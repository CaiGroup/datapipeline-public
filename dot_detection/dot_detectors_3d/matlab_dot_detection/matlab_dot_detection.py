...
def get_matlab_detected_dots(tiff_src, channel, strictness, threshold=1000, nbins=100):
    ...
    function_dir = os.path.join(cwd, 'dot_detection', 'dot_detectors_3d', 'matlab_dot_detection')
    ...
    cmd = cmd.format(bfmatlab_dir, function_dir, tiff_src, channel, threshold, nbins, strictness, dest)
