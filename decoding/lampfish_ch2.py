...
from decoding.lampfish_helpers.lampfish_funcs import get_hyb_dirs, get_loaded_tiff, get_3_by_3
...
def get_ratio_second_channel(offset_src, channel_offset_src, locations_src, tiff_dir, pos, dst, num_wav):
    ...
    for hyb in df_locs.hyb.unique():
        ...
        #---------------------------------------------------------------
        df_new_locs = df_new_locs.append(get_3_by_3(tiff_ch, df_hyb_ch, hyb_offset, hyb, new_col_name='sum_3x3_int_ch2'))
