...
# Analysis
# ----------------------------
from .false_positive_rate_analysis import get_false_pos_rate_post_seg
...
# =====================================================================================
class Post_Analyses:
    def __init__(self, position_dir, false_pos_dir, seg_dir, hamming_dir, bool_fake_barcodes, barcode_key_src,
                 num_zslices, segmentation, channels):
    ...
    def run_on_off_barcode_analysis_across(self):
        ...
        if self.segmentation != False:
            genes_assigned_to_cell_src = os.path.join(self.position_dir, 'Segmentation',
    ...
    def run_on_off_barcode_analysis_indiv(self):
        ...
        if self.segmentation != False:
            ...
            for channel in self.channels:
                ...
                genes_assigned_to_cell_src = os.path.join(self.position_dir, 'Segmentation', 'Channel_' + str(channel),
                                                          'gene_locations_assigned_to_cell.csv')
    ...
    def run_false_positive_rate_analysis_indiv(self):
        ...
        if self.segmentation != False:
            for channel in self.channels:
                ...
                get_false_pos_rate_post_seg(genes_assigned_to_cell_src, on_barcode_path, off_barcode_path,
                                            dst_file_path)
        # ----------------------------------------------------------------------------------
    ...
    def run_hamming_analysis_indiv(self):
        ...
        if self.segmentation != False:
            ...
            for channel in self.channels:
                ...
                genes_assigned_to_cell_src = os.path.join(self.seg_dir, 'Channel_' + str(channel),
                                                          'gene_locations_assigned_to_cell.csv')
...
if __name__ == '__main__':
    ...
    if sys.argv[1] == 'debug_post_analyses_class':
        ...
        post_analysis = Post_Analyses(
            position_dir='/groups/CaiLab/analyses/Michal/2021-05-20_P4P5P7_282plex_Neuro4196_5/michal_mult__3_ch/MMStack_Pos0/',
    ...
    if sys.argv[1] == 'debug_post_analyses_class_across':
        print('Debugging')
        post_analysis = Post_Analyses(
            position_dir='/groups/CaiLab/analyses/Lex/20k_dash_063021_3t3/071621_matlabdotdetection/MMStack_Pos1/',
