...
class Decoding:
    ...
    def run_decoding_across(self):
        ...
        if not self.seg:
            ...
            decoding.decoding(barcode_file_path, locations_path, self.decoded_dir, allowed_diff=self.allowed_diff,
    ...
    def run_decoding_across_2d(self):
        ...
        for z in range(self.num_zslices):
            ...
            if not self.seg:
                decoding.decoding(barcode_file_path, locations_path_z, decoding_dst_z, allowed_diff=self.allowed_diff,
                                  min_seeds=self.min_seeds)
    ...
    def run_synd_decoding_individual(self):
        ...
        for channel in self.decoding_individual:
            ...
            syndrome_decoding.run_syndrome_decoding(locations_path, barcode_src, decoding_dst_for_channel,
                                                    self.fake_barcodes,
                                                    Hpath, lat_var_factor=self.lateral_variance_factor,
                                                    z_var_factor=self.z_variance_factor,
