...
def ants_correlation(fixed_image_src, moving_image_src, return_dict):
    ...
    registration_method.SetMetricAsANTSNeighborhoodCorrelation(1)
    ...
    offset_neg = list(np.negative(offset_flip))
