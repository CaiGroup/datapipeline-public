...
if __name__ == '__main__':
    ...
    if sys.argv[1] == 'debug_fid_dot_detect_takei':
        df_tiff = get_dots_for_tiff_top(
            tiff_src='/groups/CaiLab/personal/nrezaee/raw/2020-10-19-takei/initial_fiducials/MMStack_Pos0.ome.tif',
            strictness=15,
            num_wav=4,
            dot_radius=2,
            dst='foo/final')
    ...
    if sys.argv[1] == 'debug_fid_dot_detect_linus':
        df_tiff = get_dots_for_tiff_top(
            tiff_src='/groups/CaiLab/personal/nrezaee/raw/linus_data/initial_fiducials/MMStack_Pos0.ome.tif',
            n_dots=200,
            num_wav=4,
            dot_radius=2,
            dst='foo/linus_fid')
