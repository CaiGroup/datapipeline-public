...
def get_labeled_cyto_cellpose(tiff_path, num_wav, dst=None, cyto_channel=-2, debug=False, cell_prob_threshold=0,
                              cell_flow_threshold=.4, cyto_radius=0):
    # Getting Tiff
    # ----------------------------------------------
    print('Reading TIff')
...
if __name__ == '__main__':
    ...
    if sys.argv[1] == 'debug_cellpose_cyto':
        labeled_img = get_labeled_cyto_cellpose(
