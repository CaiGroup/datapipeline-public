...
def get_labeled_imgs(raw_dir, position, segment_results_path, tiff_for_segment, bool_cyto_match, cyto_channel_num,
                     get_nuclei_img,
                     get_cyto_img, num_wav, nuclei_radius, num_z, flow_threshold, cell_prob_threshold,
                     nuclei_channel_num,
    ...
    if bool_cyto_match == True:
        ...
        # -------------------------------------------------------------
            ...
            label_img = get_labeled_img_cellpose(tiff_for_segment, dst=labeled_img_path, num_wav=num_wav,
                                                 nuclei_channel_num=nuclei_channel_num, num_z=num_z)
...
def save_labeled_img(tiff_dir, segment_results_path, position, edge_delete_dist, dist_between_nuclei, bool_cyto_match, \
                     area_tol, cyto_channel_num, get_nuclei_img, get_cyto_img, num_wav, nuclei_radius, num_z,
                     flow_threshold,
    ...
    if debug == True:
        ...
        labeled_img_path, labeled_cyto_path = get_labeled_imgs(tiff_dir, position, segment_results_path,
                                                               tiff_for_segment, bool_cyto_match,
                                                               cyto_channel_num, get_nuclei_img, get_cyto_img, num_wav,
                                                               nuclei_radius,
                                                               num_z, flow_threshold, cell_prob_threshold,
                                                               nuclei_channel_num, cyto_flow_threshold,
    ...
    if labeled_img_path != None:
        ...
        post_process(edge_delete_dist, dist_between_nuclei, labeled_img_path, labeled_cyto_path,
                     label_img_post_processed_dst)
    ...
    if bool_cyto_match:
        ...
        get_matched_3d_img(labeled_img_path, labeled_cyto_path, area_tol, post_process_dir, segment_results_path,
                           nuclei_dst, cyto_dst)
