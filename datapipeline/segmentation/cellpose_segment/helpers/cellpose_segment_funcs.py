...
if __name__ == '__main__':
    ...
    if sys.argv[1] == 'debug_gene_cell_matrix':
        ...
        df_gene_list = pd.read_csv(
            '/groups/CaiLab/analyses/real_arun/06212021_Automation_Testes_NoHydrogel/Testes_Strictness8/MMStack_Pos1/Segmentation/Channel_1/gene_locations_assigned_to_cell.csv')
