...
def get_labeled_img_cellpose(tiff_path, num_wav, nuclei_channel_num, dst=None, nuclei_radius=0, flow_threshold=.4,
                             cell_prob_threshold=0, num_z=None):
    # Getting Tiff
    # ----------------------------------------------
    print('Reading TIff')
...
if __name__ == '__main__':
    ...
    if sys.argv[1] == 'debug_cellpose_low_z':
        labeled_img = get_labeled_img_cellpose(
            tiff_path='/groups/CaiLab/personal/Lex/raw/20k_dash_063021_3t3/segmentation/MMStack_Pos1.ome.tif',
            num_wav=3,
        ...
        labeled_img = get_labeled_img_cellpose(
            tiff_path='/groups/CaiLab/personal/Michal/raw/2021-06-21_Neuro4181_5_noGel_pool1/HybCycle_9/MMStack_Pos1.ome.tif',
            num_wav=4,
