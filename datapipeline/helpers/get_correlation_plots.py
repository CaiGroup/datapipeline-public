...
def get_correlated_positions(analysis_dir):
    ...
    for channel_dir in channel_dirs:
        ...
        for pos_index_1 in range(len(position_dirs)):
            decoded_genes_csv_1 = os.path.join(position_dirs[pos_index_1], 'Segmentation', channel_dir,
                                               'gene_locations_assigned_to_cell.csv')
            for pos_index_2 in range(len(position_dirs)):
                decoded_genes_csv_2 = os.path.join(position_dirs[pos_index_2], 'Segmentation', channel_dir,
                                                   'gene_locations_assigned_to_cell.csv')
                print('--------------------------------------------------')
