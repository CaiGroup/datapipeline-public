...
def get_all_false_pos_files(analysis_dir):
    ...
    # ------------------------------------------------
    glob_me_for_false_pos_files_indiv = os.path.join(analysis_dir, 'MMStack_Pos*', 'False_Positive_Rate_Analysis',
                                                     'Channel*', 'false_positives_after_segmentation.txt')
    glob_me_for_false_pos_files_across = os.path.join(analysis_dir, 'MMStack_Pos*', 'False_Positive_Rate_Analysis',
                                                      'false_positives_after_segmentation.txt')
...
def get_false_pos_analytics(false_pos_dict, false_pos_analytics_dst):
    ...
    file1.write("25th Percentile of Normalized False Positive Rate: " + str(
        round(percentile_25_norm_false_pos * 100, 2)) + '% \n')
    file1.write("75th Percentile of Normalized False Positive Rate: " + str(
        round(percentile_75_norm_false_pos * 100, 2)) + '% \n')
    file1.close()
    # ---------------------------------------------------------
