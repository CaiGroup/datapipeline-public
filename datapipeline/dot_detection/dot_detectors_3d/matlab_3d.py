...
from datapipeline.dot_detection.dot_detectors_3d.matlab_dot_detection.matlab_dot_detector import \
    get_matlab_detected_dots
...
from datapipeline.dot_detection.preprocessing.preprocess import get_preprocess_check, tophat_3d, \
    blur_back_subtract_3d, blur_3d
import os
import sys
import warnings
...
def get_dots_for_tiff(tiff_src, offset=[0, 0, 0], analysis_name=None, bool_visualize_dots=False, \
                      ...
                      bool_radial_center=False, strictness=5, z_slices=None, nbins=100, threshold=300, num_wav=4,
                      bool_stack_z_dots=False,
                      bool_blob_removal=False, bool_rolling_ball=False, bool_tophat=False, bool_blur=False,
                      blur_kernel_size=5, rolling_ball_kernel_size=5,
